...
Looks Blog 支持关于页面和友链页面的自定义配置，你可以根据需要启用或禁用这些页面。

### 📄 关于页面

关于页面用于展示个人信息、技能专长和联系方式。
...
```json
{
  "pages": {
    "about": {
      "enabled": true,
      "title": "关于我",
      "content": "这里是关于页面的内容，支持 Markdown 格式。\n\n## 个人简介\n\n在这里写下你的个人介绍...\n\n## 技能专长\n\n- 前端开发\n- 后端开发\n- 数据库设计\n\n## 联系方式\n\n- 邮箱：your-email@example.com\n- GitHub：https://github.com/yourusername"
    }
  }
}
```
...
**配置说明：**
- `enabled` - 是否启用关于页面（true/false）
- `title` - 页面标题
- `content` - 页面内容，支持 Markdown 格式

### 🔗 友链页面

友链页面用于展示友情链接和申请友链的说明。
...
**页面特性：**
- ✅ 动态导航菜单：根据页面启用状态自动显示/隐藏导航链接
- ✅ SEO 优化：自动添加到 sitemap.xml
- ✅ 响应式设计：在不同设备上都有良好的显示效果
- ✅ Markdown 支持：关于页面内容支持 Markdown 格式
- ✅ 统计信息：关于页面自动显示文章数量、分类数量等统计
